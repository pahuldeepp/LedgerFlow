...
import { C as useQueryClient, z as onlineManager } from "./modern-C88bh2Nj.js";
import { I as lazy, K as setupStyleSheet, R as mergeProps, S as createSignal, U as render, h as createComponent } from "./6FXOYLZD-BSVQga3c.js";
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./B5PP2USH-DIwvQWJf.js"));
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./WI32IQVE-DLjH4A1g.js"));
				this.#Component = Devtools;
			}
			setupStyleSheet(this.#styleNonce, this.#shadowDOMTarget);
			return createComponent(Devtools, mergeProps({
